...
<div id="wrapper" style="text-align: center;">
    ...
    <p style="text-align: center; font-size: 378%;" class="text-secondary">
            Sign Up
...
<form action="/adda" method="post">
    <br/><br/>	<div class="col ">
	  <div class="row ">
		<input type="text" name="name" style="height: 50px;" class="form-control bg-light"  placeholder="Enter Name">
	  <c:if test="${err==1}">
	  ...
	  <br/><br/><br/>
	  <div class="row">
		<input type="password" name="password" style="height: 50px;" class="form-control bg-light" placeholder="Enter Password">
	  <c:if test="${err==2}">
	  <p style="color:red">type a password</p>
	  </c:if>
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="submit" value="Signup" class="btn btn-outline-dark btn-lg" style="width: 150px;">
        ...
        <div class="col">
            ...
            <input type="reset" value="CLEAR" class="btn btn-outline-dark btn-lg" style="width: 150px;">
        </div>
    </div>
  </form>
