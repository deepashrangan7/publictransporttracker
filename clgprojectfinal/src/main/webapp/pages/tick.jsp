...
<p style="text-align: center; font-size: 208%;" class="text-secondary">
        ...
        <p style="text-align: center; font-size: 208%;" class="text-secondary">
         Cost Per Ticket : ${price}
          </p><br/><br/>
  <%
  Double pri=(Double)request.getAttribute("price");
  Integer bno=(Integer)request.getAttribute("bno");
  %>
        <form action="/done/" method=post>
          <div class="form-group">
            <label for="exampleInputEmail1">Enter Number Of Tickets</label>
            <input type="number" class="form-control" id="ticket" name="ticket" aria-describedby="emailHelp">
            </div>
            <div class="form-group">
              <input type="submit" class="btn btn-outline-secondary btn-lg" value="Book Now" >
            </div>
              <input type="hidden" id="price" name="price" value=<%=pri%>>
        <input type="hidden" id="bus_no" name="bus_no" value=<%=bno%>>
